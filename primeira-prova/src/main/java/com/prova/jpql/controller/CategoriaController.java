...
public class CategoriaController {
    ...
    public CategoriaController(CategoriaService categoriaService, CategoriaMapper categoriaMapper, ProdutoMapper produtoMapper){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CategoriaResponse> updateById(@PathVariable Long id, @RequestBody UpdateCategoriaRequestDto request) {
    ...
    public ResponseEntity<List<ProdutoResponse>> getProdutosByCategoria(@PathVariable Long id) {
