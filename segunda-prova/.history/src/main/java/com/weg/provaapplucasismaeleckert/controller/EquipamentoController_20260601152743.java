...
public class EquipamentoController {
    ...
    public ResponseEntity<List<EquipamentoResponse>> getRelatorio(@PathVariable Long id) {
        var equipamentos = equipamentoService.getAllEquipamentoByEquipamentoId(id);
